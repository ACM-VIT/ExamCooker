...
const UploadButtonPaper: React.FC = () => {
    ...
    return (
        <div className="group relative inline-flex size-12 shrink-0 items-stretch sm:w-auto">
            ...
            <Link
                ...
                className="relative inline-flex size-full items-center justify-center gap-2 border-2 border-black bg-[#3BF4C7] px-0 text-sm font-bold text-black transition duration-150 group-hover:-translate-x-1 group-hover:-translate-y-1 dark:border-[#D5D5D5] dark:bg-[#0C1222] dark:text-[#D5D5D5] dark:group-hover:border-[#3BF4C7] dark:group-hover:text-[#3BF4C7] sm:px-4"
            >
